...
<table>
  ...
  <tbody>
    <tr>
      <td valign="top"><b>Farix</b></td>
      <td>
        This project is currently unfinished, but is one of my favourites. It's basically an operating system (currently a kernel) that I am building using C, and I have too many plans for it. Eventually, it will be finished, but I lack the time to finish it off.
      </td>
    </tr>
    <tr>
      <td valign="top"><b>HaninArchiver</b></td>
      <td>
        <img src="imgs/projects_haninarchiver_1.png" width="200" align="right" style="margin-left: 15px; margin-bottom: 5px;">
        <img src="imgs/projects_haninarchiver_2.png" width="200" align="right" style="margin-left: 15px; clear: right;">
        <p>
    ...
    <tr>
      <td valign="top"><b>DryLab++</b></td>
      <td>
        <img src="imgs/projects_drylab_1.gif" width="200" align="right" style="margin-left: 15px;">
        <p>
